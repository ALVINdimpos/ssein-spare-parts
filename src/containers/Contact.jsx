...
const Contact = () => {
  return (
    <div>
      ...
      <section className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[120px] xl:py-[150px]">
        <div className="container p-10 mx-auto mt-[-70px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  Call or send us WhatsApp message or fill out the contact form
                  with your name, email address, and message. We'll make sure to
                  respond to your inquiry as soon as possible. We look forward
                  to hearing from you!
                </p>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      Gatsata - Gasabo - Kigali
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div
                    className="bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px] cursor-pointer"
                    onClick={() => {
                      window.open("tel:+62814142579980", "_blank");
                    }}
                  >
                    <svg
                      width="32"
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div
                    className="bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px] cursor-pointer"
                    onClick={() => {
                      window.open("https://wa.me/250788295530", "_blank");
                    }}
                  >
                    <FaWhatsapp />
                  </div>
