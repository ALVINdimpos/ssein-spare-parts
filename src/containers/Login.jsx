          ...
          <div className="p-12 mx-auto bg-white rounded-3xl w-96">
            ...
            <div className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="flex justify-center w-full p-3 font-semibold tracking-wide text-gray-100 transition duration-500 ease-in bg-purple-800 rounded-lg cursor-pointer hover:bg-purple-700"
                >
                  Sign in
                </button>
              </div>
